...
const page = IT_AND_IOT_PAGE;

const whyIcons = [Shield, Network, Settings2, Zap];

export function ItAndIotIndustryPage() {
  ...
  const SectorIcon = sectorIcons[sector.icon as keyof typeof sectorIcons] ?? Monitor;
        ...
        <div className="mx-auto max-w-7xl">
          ...
          >
            ...
            <div className="relative flex flex-col gap-6 md:flex-row md:items-center md:gap-10">
              <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-brand-orange/20 ring-1 ring-brand-orange/30">
                <Cpu className="h-8 w-8 text-brand-orange" />
              </div>
              <div>
                ...
                <p className="mt-2 max-w-3xl text-lg leading-relaxed text-white/70">
                  From cloud infrastructure and cybersecurity to embedded IoT systems and
                  AI-driven software—we connect you with technologists who power digital
                  transformation.
                </p>
              </div>
            </div>
          ...
          <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-7">
            {page.coverage.sectors.map((s, i) => {
              const Icon = sectorIcons[s.icon as keyof typeof sectorIcons] ?? Monitor;
              return (
                <motion.div
                  key={s.id}
          ...
          <div className="grid gap-8 lg:grid-cols-12">
            <div className="flex gap-3 overflow-x-auto pb-2 lg:col-span-4 lg:flex-col lg:overflow-visible lg:pb-0">
              {page.coverage.sectors.map((item, i) => {
                const Icon = sectorIcons[item.icon as keyof typeof sectorIcons] ?? Monitor;
        ...
        <div className="mx-auto max-w-7xl">
          ...
          >
            <div className="flex flex-col justify-center bg-gradient-to-br from-brand-orange to-orange-700 p-8 lg:col-span-2">
              ...
              <p className="font-sans text-lg font-bold text-white">Build your tech team</p>
            </div>
